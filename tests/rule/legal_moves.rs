...
use usiagent::rule;
use usiagent::rule::{CaptureOrPawnPromotions, Checks, Evasions, EvasionsAll, NonEvasions, NonEvasionsAll, QuietsWithoutPawnPromotions, Rule};
...
#[ignore]
#[test]
fn test_generate_moves_by_nonevasions_all_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
				Path::new("data").join("floodgate").join("generatemoves").join("answer_nonevasions_all_uniq.txt")
...
#[ignore]
#[test]
fn test_generate_moves_by_nonevasions_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
			Path::new("data").join("floodgate").join("generatemoves").join("answer_nonevasions_uniq.txt")
		).unwrap()).lines()).enumerate() {
		...
		Rule::generate_moves::<NonEvasions>(teban, &state, &mc, &mut buffer).unwrap();
...
#[ignore]
#[test]
fn test_generate_moves_by_capture_or_pawn_promotions_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
			Path::new("data").join("floodgate").join("generatemoves").join("answer_capture_or_pawn_promotions_uniq.txt")
		).unwrap()).lines()).enumerate() {
		...
		Rule::generate_moves::<CaptureOrPawnPromotions>(teban, &state, &mc, &mut buffer).unwrap();
...
#[ignore]
#[test]
fn test_generate_moves_by_quiets_without_pawn_promotions_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		Rule::generate_moves::<QuietsWithoutPawnPromotions>(teban, &state, &mc, &mut buffer).unwrap();
...
#[ignore]
#[test]
fn test_generate_moves_by_evasions_all_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
			Path::new("data").join("floodgate").join("generatemoves").join("answer_evasions_all_uniq.txt")
		).unwrap()).lines()).enumerate() {
...
#[ignore]
#[test]
fn test_generate_moves_by_evasions_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
			Path::new("data").join("floodgate").join("generatemoves").join("answer_evasions_uniq.txt")
		).unwrap()).lines()).enumerate() {
		...
		Rule::generate_moves::<Evasions>(teban, &state, &mc, &mut buffer).unwrap();
...
#[ignore]
#[test]
fn test_generate_moves_by_checks_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
			Path::new("data").join("floodgate").join("generatemoves").join("answer_checks_floodgate_uniq.txt")
		).unwrap()).lines()).enumerate() {
...
#[ignore]
#[test]
fn test_generate_moves_by_checks_by_random_kyokumen_strategy() {
	let position_parser = PositionParser::new();
	...
	for (n,(sfen,answer)) in BufReader::new(
		...
		File::open(
			Path::new("data").join("random").join("generatemoves").join("answer_checks_by_random_moves_uniq.txt")
		).unwrap()).lines()).enumerate() {
