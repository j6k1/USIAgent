...
const DIAG_LEFT_BITBOARD_SLIDE_INFO: [(i32,u32,u32); 81] = [
	...
	(-1, 0, 8),(21, 1, 9),(28, 1, 8),(34, 1, 7),(39, 1, 6),(43, 1, 5),(46, 1, 4),(48, 1, 3),(-1, 1, 2),
	(-1, 0, 7),(15, 1, 8),(22, 2, 9),(29, 2, 8),(35, 2, 7),(40, 2, 6),(44, 2, 5),(47, 1, 4),(-1, 2, 3),
	(-1, 0, 6),(10, 1, 7),(16, 2, 8),(23, 3, 9),(30, 3, 8),(36, 3, 7),(41, 3, 6),(45, 3, 5),(-1, 3, 4),
	(-1, 0, 5),( 6, 1, 6),(11, 2, 7),(17, 3, 8),(24, 4, 9),(31, 4, 8),(37, 4, 7),(42, 4, 6),(-1, 4, 6),
	(-1, 0, 4),( 3, 1, 5),( 7, 2, 6),(12, 3, 8),(18, 4, 8),(25, 5, 9),(32, 5, 8),(38, 5, 7),(-1, 5, 5),
	( 1, 0, 3),( 1, 2, 4),( 4, 2, 5),( 8, 3, 6),(13, 4, 7),(19, 5, 8),(26, 6, 9),(33, 6, 8),(-1, 6, 7),
	(-1, 0, 2),( 0, 1, 3),( 2, 2, 4),( 5, 3, 5),( 9, 4, 6),(14, 5, 7),(20, 6, 8),(27, 7, 9),(-1, 7, 8),
	(-1, 0, 1),(-1, 1, 2),(-1, 2, 3),(-1, 3, 4),(-1, 4, 5),(-1, 5, 6),(-1, 6, 7),(-1, 7, 8),(28, 8, 8),
];
const DIAG_RIGHT_BITBOARD_SLIDE_INFO: [(i32,u32,u32); 81] = [
	(-1, 0, 1),(-1, 0, 2),(-1, 0, 3),(-1, 0, 4),(-1, 0, 5),(-1, 0, 6),(-1, 0, 7),(-1, 0, 8),(-1, 0, 9),
	(-1, 1, 2),( 0, 1, 3),( 1, 1, 4),( 3, 1, 5),( 6, 1, 6),(10, 1, 7),(15, 1, 8),(21, 1, 9),(-1, 0, 8),
	(-1, 2, 3),( 2, 2, 4),( 4, 2, 5),( 7, 2, 6),(11, 2, 7),(16, 2, 8),(22, 2, 9),(28, 1, 8),(-1, 0, 7),
	(-1, 3, 4),( 5, 3, 5),( 8, 3, 6),(12, 3, 7),(17, 3, 8),(23, 3, 9),(29, 2, 8),(34, 1, 7),(-1, 0, 6),
	(-1, 4, 5),( 9, 4, 6),(13, 4, 7),(18, 4, 8),(24, 4, 9),(30, 3, 8),(35, 2, 7),(39, 1, 6),(-1, 0, 5),
	(-1, 5, 6),(14, 1, 5),(19, 5, 8),(25, 5, 9),(31, 4, 8),(36, 3, 7),(40, 2, 6),(43, 1, 5),(-1, 0, 4),
	(-1, 6, 7),(20, 1, 4),(26, 2, 5),(32, 3, 6),(37, 4, 7),(41, 5, 8),(44, 6, 9),(46, 6, 8),(-1, 0, 3),
	(-1, 7, 8),(27, 1, 3),(33, 2, 4),(38, 3, 5),(42, 4, 6),(45, 5, 7),(47, 6, 8),(48, 7, 9),(-1, 0, 2),
	(-1, 8, 9),(-1, 7, 8),(-1, 6, 7),(-1, 5, 6),(-1, 4, 5),(-1, 3, 4),(-1, 2, 3),(-1, 1, 2),(-1, 0, 1)
];
const DIAG_LEFT_BITBOARD_MASK: [u64; 81] = [
	0b1111111,0b111111,0b11111,0b1111,0b111,0b11,0b1,0b0,0b0,
	0b111111,0b1111111,0b11111,0b1111,0b111,0b11,0b1,0b0,0b0,
